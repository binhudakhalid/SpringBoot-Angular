...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {		
	    ...
	    .and()
	    	.authorizeRequests()
	    	.antMatchers("/index.html", "/home#", "/login.html", "/", "/user/login","/stats","/stats.html","/stats/*"
	    			,"/stats/*/*","/platform/*" , "/service","/stats/**","/state/save","/platform","/loc**","/loc","/loc/*","/loc/**"
	    		//	,"/stats/{date}/**" ,"/stats/{date}" , "/stats/*/*","/stats/{date}" ,
	    		//	"/stats/*","/stats/{date}*"
	    			).permitAll()
